...
!media media/subchannel/thors.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:thors
    caption= THORS bundle 3A cross section.

!media media/subchannel/hex-index.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:hex_index
...
!media media/subchannel/FFM-3A.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:thors_val
...
!media media/subchannel/FFM-3A2.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:thors_val2
...
!media media/subchannel/vector_field.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:CFD-vector
    caption= CFD velocity vector field.

!media media/subchannel/velocity_field.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:CFD-velocity
    caption= CFD average axial velocity field.

!media media/subchannel/temperature_field.png
    style=width:60%;margin-bottom:2%;margin:auto;
...
!media media/subchannel/FFM-3A_massflow.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:FFM-3A_massflow
    caption= Axial profile of mass flow in center subchannel.

!media media/subchannel/FFM-3A_T.png
    style=width:60%;margin-bottom:2%;margin:auto;
...
!media media/subchannel/thors2.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:thors2
...
!media media/subchannel/FFM-5B.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:FFM-5B
...
!media media/subchannel/FFM-5B2.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:FFM-5B2
