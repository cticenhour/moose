...
!media large_media/subchannel/thors.png
...
!media large_media/subchannel/FFM-3A.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:thors_val
...
!media large_media/subchannel/FFM-3A2.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:thors_val2
...
!media large_media/subchannel/vector_field.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:CFD-vector
    caption= CFD velocity vector field.

!media large_media/subchannel/velocity_field.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:CFD-velocity
    caption= CFD average axial velocity field.

!media large_media/subchannel/temperature_field.png
    style=width:60%;margin-bottom:2%;margin:auto;
...
!media large_media/subchannel/FFM-3A_massflow.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:FFM-3A_massflow
    caption= Axial profile of mass flow in center subchannel.

!media large_media/subchannel/FFM-3A_T.png
    style=width:60%;margin-bottom:2%;margin:auto;
...
!media large_media/subchannel/thors2.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:thors2
...
!media large_media/subchannel/FFM-5B.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:FFM-5B
...
!media large_media/subchannel/FFM-5B2.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=fig:FFM-5B2
