...
!media large_media/subchannel/2x6.png
...
!media large_media/subchannel/buoyancy9.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=buoyancy9
    caption=  Velocity profile across centerline

!media large_media/subchannel/buoyancy13.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=buoyancy13
    caption=  Velocity profile across centerline

!media large_media/subchannel/coast_down.png
    style=width:60%;margin-bottom:2%;margin:auto;
    id=coast_down
